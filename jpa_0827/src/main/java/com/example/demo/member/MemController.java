...
public class MemController {
	...
	@PostMapping("/login")
	public String login(MemDTO m, HttpSession session, Model model) {
		MemDTO m2 = service.getMem(m.getId());
	...
	@PostMapping("/edit")
	public String edit(MemDTO m, HttpSession session) {
